			...
			<div className="right-col">
				<div className="title">
					...
					<div className="menu" style={menuWidth}>
						<ul>
							<li>
								<a onClick={menuLink} href="#start">
									Start
								</a>
							</li>
							<li>
								<a onClick={menuLink} href="#projects">
									Projects
								</a>
							</li>
							<li>
								<a onClick={menuLink} href="#stack">
									Stack
								</a>
							</li>
							<li>
								<a onClick={menuLink} href="#contact">
									Contact
								</a>
							</li>
						</ul>
				...
				<div className="intro">
					...
					<a
						...
						href="https://github.com/torbratsberg"
					>
